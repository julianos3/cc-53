            ...
            <div class="widget-content padding-35 bg-white clearfix">
                ...
                <div class="counter counter-md counter text-right pull-right">
                    <div class="counter-number-group">
                        <span class="counter-number"><?php echo e($contract); ?></span>
                        <span class="counter-number-related font-size-20">Contrato (s)</span>
                    </div>
                    <a href="<?php echo e(route('portal.manage.contract.index')); ?>" class="counter-label font-size-16">pŕoximos a vencer</a>
                </div>
            </div>
        </div>
    </div>
    <?php endif; ?>
    <?php if($usersForActive->count() > 0): ?>
    <div class="col-md-4">
        <div class="widget">
            <div class="widget-content padding-35 bg-white clearfix">
                <div class="pull-left white">
                ...
                <div class="counter counter-md counter text-right pull-right">
                    <div class="counter-number-group">
                        <span class="counter-number"><?php echo $usersForActive->count(); ?></span>
                        <span class="counter-number-related font-size-20">Usuário (s)</span>
                    </div>
                    <a href="<?php echo e(route('portal.condominium.user.approval.all')); ?>" class="counter-label font-size-16">para aprovação</a>
                </div>
            </div>
        </div>
    </div>
