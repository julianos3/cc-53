    ...
    <div class="page animsition">
        <div class="page-header">
            ...
            <ol class="breadcrumb" data-plugin="breadcrumb">
                ...
                <li><a href="<?php echo e(route('portal.communication.message.public.index')); ?>">Mensagens Públicas</a></li>
                <li class="active">Enviar</li>
            </ol>
            <div class="page-header-actions">
                <a href="<?php echo e(route('portal.communication.message.public.index')); ?>"
