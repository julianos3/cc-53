...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('portal/global/vendor/filament-tablesaw/tablesaw.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('portal/global/vendor/magnific-popup/magnific-popup.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('portal/global/vendor/bootstrap-select/bootstrap-select.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('portal/global/vendor/bootstrap-datepicker/bootstrap-datepicker.min.css')); ?>">
    ...
    <![endif]-->
    <!-- Scripts -->
    <script src="<?php echo e(asset('portal/global/vendor/modernizr/modernizr.min.js')); ?>"></script>
    <script src="<?php echo e(asset('portal/global/vendor/breakpoints/breakpoints.min.js')); ?>"></script>
    <script>
        Breakpoints();
    </script>
</head>
...
<?php if(session()->get('user_id') != ''): ?>
    <?php echo $__env->make('portal.layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(asset('portal/global/vendor/magnific-popup/jquery.magnific-popup.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/vendor/bootstrap-select/bootstrap-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/vendor/formatter-js/jquery.formatter.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/vendor/bootstrap-datepicker/bootstrap-datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/js/plugins/responsive-tabs.min.js')); ?>"></script>
