<?php $__env->startSection('content'); ?>
    ...
    <div class="page animsition">
        ...
        <div class="page-content">
            ...
            <?php echo $__env->make('portal.modals.confirm', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo $__env->make('portal.condominium.user.modal.modal_show_user', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                ...
                                <div class="widget-header">
                                    <div class="widget-header-content">
                                        ...
                                        <button title="Visualizar"
                                                ...
                                                data-route="<?php echo e(route('portal.condominium.user.approval.show', ['id' => $row->id])); ?>"
                                                data-route-btn="<?php echo e(route('portal.condominium.user.approval.confirm', ['id' => $row->id])); ?>">
                                        ...
                                        <button title="Excluir"
                                                ...
                                                data-route="<?php echo e(route('portal.condominium.user.destroy-active', ['id' => $row->id])); ?>">
