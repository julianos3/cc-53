...
<head>
    ...
    <meta name="url" content="<?php echo e(config('app.url')); ?>" />
    ...
    <!-- css -->
    <link rel="stylesheet" href="<?php echo e(asset('site/css/reset.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('site/css/estilo.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('site/css/main.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('site/css/responsive.css')); ?>" type="text/css">
...
<header class="def-100 fixed z-index-9995 p-top-15 p-bottom-15 <?php if(Route::current()->uri() != 'home' && Route::current()->uri() != '/'): ?> in-scroll page-internal <?php endif; ?>">
    <div class="def-center">
        <figure class="f-left c-left main-logo">
            <a href="<?php echo e(route('site.index')); ?>" title="<?php echo e(config('app.name')); ?>">
                <img src="<?php echo e(asset('site/images/main-logo.png')); ?>" title="<?php echo e(config('app.name')); ?>" alt="<?php echo e(config('app.name')); ?>" />
            </a>
        </figure>
        ...
        <nav class="f-right c-left m-top-25 main-menu m-top-1280-10 display-1024-none fixed-1024 top-1024-0 left-1024-0 w-1024-100 f-1024-l h-1024-100 m-top-1024-0">
            <ul class="w-1024-100 h-1024-100 m-top-1024-0">
                ...
                <li class="w-1024-100">
                    <a class="w-1024-90 p-left-1024-5 p-right-1024-5 h-1024-100" href="<?php echo e(route('site.index')); ?>" title="HOME">
                        <span class="table w-1024-100 h-1024-100">
                            <b class="inline f-1024-n">
                                HOME
                            </b>
                ...
                <li class="w-1024-100">
                    <a class="w-1024-90 p-left-1024-5 p-right-1024-5 h-1024-100" href="<?php echo e(route('site.funcionalidades')); ?>" title="FUNCIONALIDADES">
                        <span class="table w-1024-100 h-1024-100">
                            <b class="inline f-1024-n">
                                FUNCIONALIDADES
                            </b>
                ...
                <li class="w-1024-100">
                    <a class="w-1024-90 p-left-1024-5 p-right-1024-5 h-1024-100" href="<?php echo e(route('site.beneficios')); ?>" title="BENEFÍCIOS">
                        <span class="table w-1024-100 h-1024-100">
                            <b class="inline f-1024-n">
                                BENEFÍCIOS
                            </b>
                ...
                <li class="w-1024-100">
                    <a class="w-1024-90 p-left-1024-5 p-right-1024-5 h-1024-100" href="<?php echo e(route('site.blog')); ?>" title="BLOG">
                        <span class="table w-1024-100 h-1024-100">
                            <b class="inline f-1024-n">
                                BLOG
                            </b>
                ...
                <li class="w-1024-100">
                    <a class="w-1024-90 p-left-1024-5 p-right-1024-5 h-1024-100" href="<?php echo e(route('site.contato')); ?>" title="CONTATO">
                        <span class="table w-1024-100 h-1024-100">
                            <b class="inline f-1024-n">
                                CONTATO
                            </b>
                ...
                <li class="w-1024-100">
                    <a class="w-1024-90 p-left-1024-5 p-right-1024-5 h-1024-100" target="_blank" href="<?php echo e(route('register')); ?>" title="EXPERIMENTE GRÁTIS">
                        <span class="table w-1024-100 h-1024-100">
                            <b class="inline f-1024-n">
                                EXPERIMENTE GRÁTIS
                            </b>
                ...
                <li class="w-1024-100">
                    <a class="w-1024-90 p-left-1024-5 p-right-1024-5 h-1024-100" target="_blank" href="<?php echo e(route('login')); ?>" title="ENTRAR NO SISTEMA">
                        <span class="table w-1024-100 h-1024-100">
                            <b class="inline f-1024-n">
                                ENTRAR NO SISTEMA
                            </b>
            ...
            <div class="def-100 w-1024-100">
                ...
                <nav class="def-20 m-left-5 menu-footer w-800-100">
                    <ul class="def-48 w-600-100">
                        ...
                        <li>
                            <a href="<?php echo e(route('site.index')); ?>" title="Home">
                                Home
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('site.funcionalidades')); ?>" title="Funcionalidades">
                                Funcionalidades
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('site.beneficios')); ?>" title="Benefícios">
                                Benefícios
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('site.blog')); ?>" title="Blog">
                                Blog
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('site.contato')); ?>" title="Contato">
                                Contato
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('register')); ?>" target="_blank" title="Experimente Gratis">
                                Experimente Gratis
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('login')); ?>" target="_blank"  title="Entrar no sistema">
                                Entrar no sistema
                            </a>
                        </li>
                    </ul>
...
<!-- js -->
<script type="text/javascript" src="<?php echo e(asset('site/js/cycle.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('site/js/plugins/masked.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('site/js/main.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('site/js/plugins/scrollreveal/scrollReveal.js')); ?>"></script>
<script type="text/javascript">
    window.scrollReveal = new scrollReveal();
</script>
<script type="text/javascript" src="<?php echo e(asset('site/js/plugins/slick/slick.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('site/js/plugins/slick/scripts.js')); ?>"></script>
</body>
</html>