...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('portal/assets/pages/css/login.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('portal/assets/pages/css/forgot-password.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('portal/global/vendor/waves/waves.min.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('portal/assets/pages/css/register.css')); ?>">
    <!-- Fonts -->
...
<script src="<?php echo e(asset('portal/global/vendor/screenfull/screenfull.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/vendor/slidepanel/jquery-slidePanel.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/vendor/jquery-placeholder/jquery.placeholder.min.js')); ?>"></script>
<!-- Scripts -->
...
<script src="<?php echo e(asset('portal/global/js/configs/config-colors.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/assets/js/configs/config-tour.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('portal/global/js/components/jquery-placeholder.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/js/components/animate-list.min.js')); ?>"></script>
<script src="<?php echo e(asset('portal/global/js/components/material.min.js')); ?>"></script>
<script>
