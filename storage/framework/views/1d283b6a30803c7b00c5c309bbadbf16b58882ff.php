    ...
    <div class="page animsition">
        <div class="page-header">
            ...
            <ol class="breadcrumb" data-plugin="breadcrumb">
                ...
                <li><a href="<?php echo e(route('portal.communication.message.private.index')); ?>">Mensagens Privadas</a></li>
                <li class="active">Enviar</li>
            </ol>
            <div class="page-header-actions">
                <a href="<?php echo e(route('portal.communication.message.private.index')); ?>"
        ...
        <div class="page-content">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <?php echo Form::open(['route'=>'portal.communication.message.private.store']); ?>


                    <?php echo $__env->make('portal.communication.message.private._form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
