            ...
            <div>
                <ul class="site-menu">
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="<?php echo e(url('portal/home.index')); ?>">
                    ...
                    <li class="site-menu-item has-sub">
                        ...
                        <ul class="site-menu-sub">
                            <li class="site-menu-item has-sub">
                                ...
                                <ul class="site-menu-sub">
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/block')); ?>">
                                            <span class="site-menu-title">Blocos</span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/unit')); ?>">
                                            <span class="site-menu-title">Unidades</span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/unit/garage')); ?>">
                                    ...
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/security-cam')); ?>">
                            ...
                            <li class="site-menu-item has-sub">
                                ...
                                <ul class="site-menu-sub">
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/user')); ?>">
                                            <span class="site-menu-title">Integrantes</span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/group')); ?>">
                            ...
                            <li class="site-menu-item has-sub">
                                ...
                                <ul class="site-menu-sub">
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/provider')); ?>">
                                            <span class="site-menu-title">Fornecedores</span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(url('portal/condominium/provider/category')); ?>">
                    ...
                    <li class="site-menu-item has-sub">
                        ...
                        <ul class="site-menu-sub">
                            <li class="site-menu-item">
                                <a class="animsition-link" href="<?php echo e(url('portal/manage.contracts.index')); ?>">
                                    <span class="site-menu-title">Contratos</span>
                                </a>
                            </li>
                            <li class="site-menu-item">
                                <a class="animsition-link" href="<?php echo e(url('portal/manage.maintenance.index')); ?>">
                                    <span class="site-menu-title">Manutenções Preventivas</span>
                                </a>
                            </li>
                            <li class="site-menu-item">
                                <a class="animsition-link" href="<?php echo e(url('portal/manage.reserve-areas.index')); ?>">
                    ...
                    <li class="site-menu-item has-sub">
                        ...
                        <ul class="site-menu-sub">
                            <li class="site-menu-item active">
                                <a class="animsition-link active" href="<?php echo e(url('portal/communication.message.public.index')); ?>">
                                    <span class="site-menu-title">Mensagens Públicas</span>
                                </a>
                            </li>
                            <li class="site-menu-item none">
                                <a class="animsition-link" href="<?php echo e(url('portal/communication.message.private.index')); ?>">
                            ...
                            <li class="site-menu-item">
                                <a class="animsition-link" href="<?php echo e(url('portal/communication.called.index')); ?>">
                                    <span class="site-menu-title">Meus Chamados</span>
                                </a>
                            </li>
                            <li class="site-menu-item">
                                <a class="animsition-link" href="<?php echo e(url('portal/communication.called.category.index')); ?>">
                            ...
                            <li class="site-menu-item">
                                <a class="animsition-link" href="<?php echo e(url('portal/communication.communication.index')); ?>">
