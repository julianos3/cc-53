...
<?php $__env->startSection('content'); ?>
        ...
        <div class="page-content">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <a href="<?php echo e(route('portal.condominium.unit.garage.create')); ?>"
                       data-toggle="tooltip"
                                ...
                                <table class="tablesaw table-striped table-bordered table-hover"
                                    ...
                                    <?php $__currentLoopData = $dados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php if($row->unit_id): ?> <?php echo e($row->unit->name); ?> <?php endif; ?></td>
                                            <td><?php echo e($row->block->name); ?></td>
                                            <td class="text-center">
                                                <a href="<?php echo e(route('portal.condominium.unit.garage.edit', ['id' => $row->id])); ?>"
                                                   title="Editar"
    ...
    <a href="<?php echo e(route('portal.condominium.unit.garage.create')); ?>" title="Cadastrar"
       data-toggle="tooltip"
       data-original-title="Cadastrar"
