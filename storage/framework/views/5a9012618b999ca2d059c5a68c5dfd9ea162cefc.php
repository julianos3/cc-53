            ...
            <table align="left" width="20%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth">
                <tr>
                    <td valign="middle" align="left" class="center" style="padding:20px 10px 0 20px">
                        <a href="<?php echo e(config('app.url')); ?>" title="<?php echo e(config('app.name')); ?>">
                            <img src="<?php echo e(asset('portal/assets/images/email/logo-2.png')); ?>" alt="<?php echo e(config('app.name')); ?>" title="<?php echo e(config('app.name')); ?>" border="0" class="deviceWidth" />
                        </a>
                    </td>
                </tr>
            </table>
