        ...
        <div class="page-content">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <?php echo Form::open(['route'=>'portal.condominium.user.store']); ?>


                    <?php echo $__env->make('portal.condominium.user._form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                    <div class="form-group text-right">
                        <button type="submit" data-toggle="tooltip" data-original-title="Cadastrar Integrante" class="btn btn-success waves-effect waves-light">
