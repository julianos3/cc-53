<?php $__env->startSection('content'); ?>
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            <?php echo Form::open(['route'=>'admin.blog.store', 'files'=> true]); ?>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <a href="<?php echo e(route('admin.blog.index')); ?>" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-undo"></i> Voltar</a>
                    </div>
                </div>
