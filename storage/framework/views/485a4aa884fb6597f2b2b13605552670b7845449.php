        ...
        <div class="def-center">
                    ...
                    <ul class="def-100">
                        <li class="def-100">
                            <div class="def-100 background-white border-grey-2">
                                <?php if($blog->images): ?>
                                    <?php $__currentLoopData = $blog->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <figure class="def-90 m-top-30 m-left-5 w-800-100 m-top-800-0">
                                        <img class="def-100" src="<?php echo asset('uploads/blog/'.$image->image); ?>" title="" alt="" />
                                    </figure>
                                ...
                                <div class="def-90 m-left-5 p-top-30 p-bottom-30">
                                    ...
                                    <div class="def-100 m-top-30">
                                        <div class="f-left c-left">
                                            <figure>
                                                <img src="<?php echo asset('site/images/icons/calendar.png'); ?>" />
                                            </figure>
                                        ...
                                        <div class="f-left c-left m-left-25-px">
                                            <a class="f-left click-and-scroll" href="comentarios" title="DEIXA UM COMENTÁRIO">
                                                <figure>
                                                    <img src="<?php echo asset('site/images/icons/comment.png'); ?>" />
                                                </figure>
            ...
            <aside class="def-30 bx-white f-right w-1024-50 f-1024-l m-left-1024-25 m-top-1024-30 w-800-100">
                <div class="def-90 p-left-5 p-right-5 p-top-20 p-bottom-20 border-grey-2">
                    ...
                    <?php endif; ?>
                    <?php if(!$lastBlogs->isEmpty()): ?>
                    <nav class="def-100 m-top-30 list-group-category">
                        <ul class="def-100">
                            <li class="def-100 title-category">
                                ÚLTIMOS POSTS
                            </li>
                            <?php $__currentLoopData = $lastBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lastBlog): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <li class="def-100">
                                <a href="<?php echo e(route('site.blog.show', ['id' => $lastBlog->id, 'seoLink' => $lastBlog->seo_link])); ?>" title="<?php echo $lastBlog->name; ?>">
                                    - <?php echo $lastBlog->name; ?>
