            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <div class="mb-md">
                            <a href="<?php echo e(route('admin.blog.create')); ?>" title="Cadastrar" class="btn btn-success"><i class="fa fa-plus"></i> Cadastrar</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover table-striped table-condensed mb-none">
                        ...
                        <?php $__currentLoopData = $dados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo e(date('d/m/Y', strtotime($row->date))); ?></td>
                                <td class="text-center"><?php echo e(date('d/m/Y H:i', strtotime($row->date_publish))); ?></td>
                                <td class="text-center">
                                    <div class="switch ativo switch-sm switch-success">
                                        <input type="checkbox" name="switch" data-route="<?php echo e(route('admin.blog.active', ['id' => $row->id])); ?>" data-plugin-ios-switch <?php if($row->active == 'y'): ?> checked="checked" <?php endif; ?> />
                                    </div>
                                </td>
                                <td class="actions text-center">
                                    <a href="<?php echo e(route('admin.blog.tags.index', ['id' => $row->id])); ?>" class="on-default edit-row" title="Tags">
                                        <i class="fa fa-tags"></i>
                                        Tags
                                    </a>
                                    <a href="<?php echo e(route('admin.blog.galery.index', ['id' => $row->id])); ?>" class="on-default edit-row" title="Galeria">
                                        <i class="fa fa-image"></i>
                                        Galeria
                                    </a>
                                    <a href="<?php echo e(route('admin.blog.edit', ['id' => $row->id])); ?>" class="on-default edit-row" title="Editar">
                                        <i class="fa fa-pencil"></i>
                                        Editar
                                    </a>
                                    <a href="#modalAnim" data-route="<?php echo e(route('admin.blog.destroy', ['id' => $row->id])); ?>" class="on-default excluir remove-row" title="Excluir">
