            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('admin.associated.export') }}" class="mb-xs mt-xs mr-xs btn btn-warning"><i class="fa fa-file-excel-o"></i> Exportar</a><br /><br />
                    </div>
                </div>
                        ...
                        @foreach($dados as $row)
                            <tr>
                                ...
                                <td class="actions text-center">
                                    <a href="{{ route('admin.associated.show', ['id' => $row->id]) }}" class="on-editing cancel-row" title="Visualizar">
                                        <i class="fa fa-search-plus"></i>
                                        Visualizar
                                    </a>
                                    <a href="#modalAnim" data-route="{{ route('admin.associated.destroy', ['id' => $row->id]) }}" class="on-default excluir remove-row" title="Excluir">
