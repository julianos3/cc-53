...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label class="control-label">Imagem <strong>( 1024px X 480px, conteúdo principal centralizado )</strong></label>
            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="input-append">
                    ...
                    <a href="{{ asset('uploads/banner-mobile/'.$dados->image) }}" class="lightBox btn btn-default active">Visualizar Imagem</a>
                    <a href="{{ route('admin.banners-mobiles.destroyImage', ['id' => $dados->id]) }}" class="btn btn-default">Deletar</a>
                    <?php } ?>
                </div>
            </div>
        </div>
