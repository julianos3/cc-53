        ...
        <div class="form-group">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="input-append">
                    ...
                    <a href="{{ asset('uploads/partners/'.$dados->image) }}" class="lightBox btn btn-default active">Visualizar Imagem</a>
                    <a href="{{ route('admin.partners.destroyImage', ['id' => $dados->id]) }}" class="btn btn-default">Deletar</a>
                    <?php } ?>
                </div>
            </div>
        </div>
