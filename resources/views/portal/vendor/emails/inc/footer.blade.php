                ...
                <tr>
                    <td valign="middle" align="left" class="center" style="padding:20px 10px 0 20px">
                        <a href="{{ config('app.url') }}" title="{{ config('app.name') }}">
                            <img src="{{ asset('portal/assets/images/email/logo-2.png') }}" alt="{{ config('app.name') }}" title="{{ config('app.name') }}" border="0" class="deviceWidth" />
                        </a>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="font-size: 1.2em; line-height: 1.4em; color: #9a9b9f; font-weight: normal; text-align: left; font-family: Arial; vertical-align: top; padding:30px 0 20px 15px">
                        <p style="mso-table-lspace:0;mso-table-rspace:0; margin:0">
                            Saudações da Equipe <strong>{{ config('app.name') }}</strong><br/>
                            (51) 99285.1726 | <a href="{{ config('app.url') }}" style="color: #9a9b9f; text-decoration: none;" title="{{ config('app.name') }}">www.centralcondo.com.br</a>
                        </p>
                    </td>
                </tr>
            </table>
