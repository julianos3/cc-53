...
@section('content')
        ...
        <div class="page-content">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <a href="{{ route('portal.communication.communication-condominium.create') }}"
                       data-toggle="tooltip"
                                    ...
                                    @foreach($dados  as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('portal.communication.communication-condominium.show', ['id' => $row->id]) }}"
                                                   title="Visualizar"
                                                   class="btn btn-icon bg-success waves-effect waves-light">
                                                    <i class="icon wb-zoom-in" aria-hidden="true"></i>
                                                </a>
                                                <a href="{{ route('portal.communication.communication-condominium.edit', ['id' => $row->id]) }}"
                                                   title="Editar"
                                                ...
                                                <button title="Excluir"
                                                        ...
                                                        data-route="{{ route('portal.communication.communication-condominium.destroy', ['id' => $row->id]) }}">
    ...
    @if(session()->get('admin') == 'y')
    <a href="{{ route('portal.communication.communication-condominium.create') }}" title="Novo Comunicado"
       data-toggle="tooltip"
       data-original-title="Novo Comunicado"
