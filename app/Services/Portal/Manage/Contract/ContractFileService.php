...
class ContractFileService
{
                                ...
                                UtilObjeto $utilObjeto)
    {
        ...
        $this->path = 'portal/' . session()->get('condominium_id') . '/manage/contract/';
    }
    ...
    public function createMultiple($id, array $data)
    {
        ...
        foreach ($data['files'] as $file) {
            ...
            if ($result) {
                ...
                $dados['mime_type'] = $result['mime_type'];
    ...
    public function create(array $data)
    {
        try {
            ...
            if ($dados) {
                $response = trans("Arquivo cadastrado com sucesso!");
    ...
    public function update(array $data, $id)
    {
        try {
            ...
            if ($dados) {
                $response = trans("Arquivo alterado com sucesso!");
                return redirect()->back()->with('status', trans($response));
            }
        } catch (ValidatorException $e) {
            return redirect()->back()->withErrors($e->getMessageBag())->withInput();
