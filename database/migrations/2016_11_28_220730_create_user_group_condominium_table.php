...
class CreateUserGroupCondominiumTable extends Migration
{
	...
	public function up()
	{
		Schema::create('user_group_condominium', function(Blueprint $table) {
            $table->increments('id');
	...
	{
		Schema::drop('user_group_condominium');
	}
