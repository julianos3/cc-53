 ...
 * Generated for Laravel 5.3.29 on 2017-02-07.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \CentralCondo\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CentralCondo\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function command($signature, $callback){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CentralCondo\Console\Kernel::command($signature, $callback);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CentralCondo\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CentralCondo\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CentralCondo\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CentralCondo\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CentralCondo\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CentralCondo\Console\Kernel::bootstrap();
        }
        ...
        public static function setArtisan($artisan){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CentralCondo\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \CentralCondo\Entities\Portal\User\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \CentralCondo\Entities\Portal\User\User|false 
         * @static 
         */
         ...
         *
         * @return \CentralCondo\Entities\Portal\User\User 
         * @static 
         */
